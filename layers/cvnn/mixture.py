...
class ComplexMixture(Layer):
    ...
    def call(self, inputs):
        ...
        input_real = K.expand_dims(inputs[0]) 
        input_imag = K.expand_dims(inputs[1]) 
        
        input_real_transpose = K.expand_dims(inputs[0], axis = ndims-1) 
        input_imag_transpose = K.expand_dims(inputs[1], axis = ndims-1) 
        ...
        if self.average_weights:
            ...
            output_imag = output_imag*newweight
